...
if __name__ == '__main__':
    ...
    # syn foggy-rain
    parser.add_argument('--restore_flow_synimg_ckpt', help="restore checkpoint")   # fog
    parser.add_argument('--restore_flow_synimg_rain_ckpt', help="restore checkpoint")  # rain
    # real foggy
    ...
    parser.add_argument('--use_contra_loss', action='store_true', help='use contrastive learning loss')
    ...
    if args.stage == 'kitti_s1':
        model.stage_1_train()
    elif args.stage == 'kitti_s2':
        model.stage_2_train()
    elif args.stage == 'kitti_s3':
        ...
        model.stage_6_train()
    elif args.stage == 'real_rain':
        model.stage_7_train()
    else:
        raise ValueError("Unknown training stage {}".format(args.stage))
